...
import co.anbora.labs.apiblueprint.viewer.ide.utils.addTextChangeListener
import co.anbora.labs.apiblueprint.viewer.ide.utils.pathAsPath
...
class AglioToolchainPathChoosingComboBox(onTextChanged: () -> Unit = {}) :
